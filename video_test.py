...
def object_compare(drone1_pred, drone2_pred, drone1_image, drone2_image, img, img2, names, deepsort, distance_metric, start_time):
    ...
    for i, det in enumerate(drone1_pred):
        ...
        if det is not None and len(det):
            ...
            for c in det[:, -1].unique():
                n = (det[:, -1] == c).sum()  # detections per class
                info += '%g %ss, ' % (n, names[int(c)])  # add to string
...
def detect(opt):
    ...
    path1 = "C:/Users/cjh/Desktop/Yolov5_DeepSort_Pytorch/unity_dataset/drone1/305.png"
    path2 = "C:/Users/cjh/Desktop/Yolov5_DeepSort_Pytorch/unity_dataset/drone2/305.png"
    while True:
